...
src_install() {
	...
	insinto /usr/share/sunshine
	doins "${WORKDIR}"/${P}/src_assets/linux/assets/apps.json
	doins -r "${FILESDIR}"/web

	# # web
	# insinto /usr/share/sunshine/web/node_modules/bootstrap/dist/css
	# doins -r "${FILESDIR}"/bootstrap.min.css

	# insinto /usr/share/sunshine/web/node_modules/@fortawesome/fontawesome-free/css
	# doins -r "${FILESDIR}"/all.min.css

	# insinto /usr/share/sunshine/web/node_modules/vue/dist
	# doins -r "${FILESDIR}"/vue.min.js

	# insinto /usr/share/sunshine/web/node_modules/bootstrap/dist/js
	# doins -r "${FILESDIR}"/bootstrap.bundle.min.js
